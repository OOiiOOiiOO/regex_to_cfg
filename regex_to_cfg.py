...
print('$$$___________Regex To CFG___________$$$')
print('\n')
print('*************  Developed By: ooiioooiioo  *************')
print('++_____Visit My Blog and Github_____++')
print('https://github.com/OOiiOOiiOO')
print('http://khorsandaalam.ihweb.ir')
print('\n')
...
# Main
print('Enter the first regex؛')
regex1 = input()
print('Enter the second regex:')
regex2 = input()
# Check
...
print('This is the input alphabet : ' + ''.join(sorted(alphabet)))
# Operating with first regex
print('This is the parsing of the first regular expression in a k-c grammar : \n')
myList = dfa1.write(0)
...
print('This is the parsing of the second regular expression in the k-c grammar : \n')
...
print('Result in context-free grammar :')
#print(second)
normal_print(second)
print('Final result :')
#print('ab(b|c*)')
